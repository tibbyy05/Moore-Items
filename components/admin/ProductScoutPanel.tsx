...
export default function ProductScoutPanel() {
...
function ProductCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden flex flex-col">
      {/* Image — click to open Quick View */}
      <button
        onClick={onQuickView}
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-end justify-center pb-3">
          <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs font-medium text-white bg-black/60 px-3 py-1 rounded-full flex items-center gap-1.5">
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <div className="mt-auto space-y-2">
          ...
          <button
            ...
            className={`w-full py-2 border rounded-lg text-xs font-medium transition-colors flex items-center justify-center gap-1.5 ${
              saved
            ...
            {product.images.length > 1 && (
              <div>
                <p className="text-xs text-gray-400 mb-2">
                  {product.images.length} images &mdash; {selectedImage + 1} of {product.images.length}
                </p>
                  ...
                  {product.images.map((img, i) => (
                    <button
                      ...
                      className={`w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden border-2 transition-colors ${
                        selectedImage === i ? 'border-gold-500 ring-2 ring-gold-500/30' : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
